...
class __TwigTemplate_bc3cd2b30fe56af58b48b56e432218b13806d2cea915de8e550b32839aae45ab extends \Twig\Template
{
    private $source;
    private $macros = [];
...
%}
<div{{ attributes.addClass('margin-y-1') }}>
  {% if label_hidden == false %}
  <div{{ title_attributes.addClass(title_classes) }}>{{ label }}</div>
  {% endif %}
  {% for item in items %}
    <span class=\"margin-2px\">
          <a href=\"{{ item.content['#url'] }}\" class=\"usa-tag\">
            {{ item.content['#title'] }}
          </a>
    </span>
  {% endfor %}
</div>
", "themes/contrib/uswds_base/templates/field/field--field-tags.html.twig", "/Users/irenerojas/Code/irene_drupal/themes/contrib/uswds_base/templates/field/field--field-tags.html.twig");
    }
