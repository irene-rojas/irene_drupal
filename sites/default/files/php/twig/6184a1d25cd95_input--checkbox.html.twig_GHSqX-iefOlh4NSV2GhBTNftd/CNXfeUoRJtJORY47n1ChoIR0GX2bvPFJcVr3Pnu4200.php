...
class __TwigTemplate_7b3619c2dc94ba86079bb4601370b256303d9e4e0de6aa2805a8d91ee99d2bbe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% spaceless %}
    ...
    {% block input %}
        <input{{ attributes.addClass('usa-checkbox__input') }} />
    {% endblock %}
    ...
    {{ children }}
{% endspaceless %}
", "themes/contrib/uswds_base/templates/input/input--checkbox.html.twig", "/Users/irenerojas/Code/irene_drupal/themes/contrib/uswds_base/templates/input/input--checkbox.html.twig");
    }
