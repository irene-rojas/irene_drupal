...
class __TwigTemplate_c328cdeab02713f54f37d5c557c5bd5855e9fc7f27d0fffbae17db5ef77c91c7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% spaceless %}
    ...
    {% block input %}
        <input{{ attributes.addClass('usa-button') }} />
    {% endblock %}
    ...
    {{ children }}
{% endspaceless %}
", "themes/contrib/uswds_base/templates/input/input--submit.html.twig", "/Users/irenerojas/Code/irene_drupal/themes/contrib/uswds_base/templates/input/input--submit.html.twig");
    }
