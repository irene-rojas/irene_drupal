...
class __TwigTemplate_6f9ea90b95745d3f6079909f627d61c1b09731808ef7d66abea8e51529ca2c21 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
#}
{% if primary %}
  <h2 class=\"usa-sr-only\">{{ 'Primary tabs'|t }}</h2>
  <div class=\"usa-list.usa-list--unstyled\">{{ primary }}</div>
{% endif %}
{% if secondary %}
  <h2 class=\"usa-sr-only\">{{ 'Secondary tabs'|t }}</h2>
  <div class=\"usa-list.usa-list--unstyled\">{{ secondary }}</div>
{% endif %}
", "themes/contrib/uswds_base/templates/navigation/menu-local-tasks.html.twig", "/Users/irenerojas/Code/irene_drupal/themes/contrib/uswds_base/templates/navigation/menu-local-tasks.html.twig");
    }
