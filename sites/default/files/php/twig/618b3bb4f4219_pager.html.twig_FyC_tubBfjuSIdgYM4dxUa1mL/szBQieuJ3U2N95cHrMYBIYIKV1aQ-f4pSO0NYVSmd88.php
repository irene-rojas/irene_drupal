...
class __TwigTemplate_9e09e7786a915e50ee3ee8547d6773391c1237bcb17cb7064220075f0088f0c2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if items %}
  <nav class=\"pager\" role=\"navigation\" aria-labelledby=\"pagination-heading\">
    <h4 id=\"pagination-heading\" class=\"usa-sr-only\">{{ 'Pagination'|t }}</h4>
    <ul class=\"usa-nav__primary usa-accordion js-pager__items\">
      ...
      {% for key, item in items.pages %}
        <li class=\"usa-nav__primary-item{{ current == key ? ' is-active' : '' }}\">
          {% if current == key %}
...
{% endif %}
", "themes/contrib/uswds_base/templates/navigation/pager.html.twig", "/Users/irenerojas/Code/irene_drupal/themes/contrib/uswds_base/templates/navigation/pager.html.twig");
    }
